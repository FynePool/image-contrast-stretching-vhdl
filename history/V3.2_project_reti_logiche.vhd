...
architecture Behavioral of project_reti_logiche is
    ...
    type STATE_type is (IDLE , SEND_ADDR, READ, READ2, TESTREAD, SETUP, ELAB ,write2, WRITE ,ENDWR);
    signal MEM                              : MEM_type ;
              ...
              if i_rst='1' then --Definition of reset
                  ...
                  case STATE is
                    ...
                    when TESTREAD =>
                            ...
                            if to_integer(unsigned(MEM(0)))=0 then   --TESTTESTTESTTESTTESTTEST
                                 STATE <= ENDWR;
                            elsif to_integer(unsigned(MEM(1)))=0 then   --TESTTESTTESTTESTTESTTEST
                                 STATE <= ENDWR;
                            else
                                STATE <= READ2;
                            end if;
                    ...
                    when SETUP =>
                        ...
                        if to_integer(unsigned(delta_value)) = 0 then  --TESTTESTtESTtESTtESTtEST
                            STATE <= ENDWR;
                        end if; 
